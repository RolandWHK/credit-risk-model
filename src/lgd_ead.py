...
Original file is located at
    https://colab.research.google.com/drive/1nCXNKtA8e7a9abyPjjFja4T2IahCPl8J
"""

import numpy as np
import pandas as pd

loan_data_preprocessed_backup = pd.read_csv('/content/sample_data/loan_data_2007_2014_preprocessed.csv')
...
plt.savefig('recovery_rate_dist.png', dpi=300, bbox_inches='tight')

plt.hist(loan_data_defaults['CCF'], bins = 100)
plt.savefig('CCF_dist.png', dpi=300, bbox_inches='tight')
...
lgd_inputs_stage_1_train['open_acc']
...
plt.title('ROC curve')
plt.savefig('roc_curve_lgd.png', dpi=300, bbox_inches='tight')
...
plt.savefig('lgd_residuals.png', dpi=300, bbox_inches='tight')
...
plt.savefig('ead_residuals.png', dpi=300, bbox_inches='tight')
...
loan_data_inputs_train = pd.read_csv('/content/sample_data/loan_data_inputs_train.csv')

loan_data_inputs_test = pd.read_csv('/content/sample_data/loan_data_inputs_test.csv')
...
reg_pd = pickle.load(open('/content/sample_data/pd_model.sav', 'rb'))
